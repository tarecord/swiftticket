...
class LoginSystem {
	...
	/* Start Config */
 	...
 	private $dbname = "swiftticket"; // Database Name
 	private $dbtable = "users"; // Your Users Table
 
 	private $secureKey    = "sadauj3n(#ff)#%$"; // A Secure Key For Cookie Encryption. Don't make this public
 	private $passwordSalt = "vdsjn3md%##$*5"; // Secret Password Salt. Only change once before setting user registration public.
 	private $company      = "Swift Ticket"; // Company for name for including in emails
	...
	var $blockBruteForce	= true; // Deny login for $LS->bfTime seconds after incorrect login tries of 5
		...
		/* Extra Settings*/
			...
			private $homePage     	= "/?p=home"; // The home page. The main page for logged in users. Redirects to here when logs in
